...
class AcerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Acer Products'),
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ProductDetailPage(
                            product: product,
                            onAddToCart: onAddToCart, // Use the callback from parent
                          ),
                        ),
                      );
                    },
